...
**CompanyApiSolution** is a .NET 6+ Web API application for managing company records. It supports operations such as creating, retrieving, and updating companies with the following fields:
